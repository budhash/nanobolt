...
def get_license_info(license: str) -> tuple:
    license_mapping = {
        ...
        "gpl": ("GNU General Public License v3.0 or later", "License :: OSI Approved :: GNU General Public License v3 or later (GPLv3+)"),
        "lgpl": ("GNU Lesser General Public License v3.0 or later", "License :: OSI Approved :: GNU Lesser General Public License v3 or later (LGPLv3+)"),
        "agpl": ("GNU Affero General Public License v3.0 or later", "License :: OSI Approved :: GNU Affero General Public License v3 or later (AGPLv3+)")
    }
